    ...
    def run(self, words, tags, heads, rels, bi_chunk, isTrain):
        ...
        if isTrain:
            ...
            if config.exclude_puncts:
                cor_arc_mask = np.multiply(np.equal(res_arc, heads), punct_mask)
            else:
        ...
        return loss_arc + loss_bi + loss_rel, num_cor_arc, num_cor_arc_intra, tot_arc_intra, num_cor_rel, cor_rel, gold_rels, system_rels, cor_bi
